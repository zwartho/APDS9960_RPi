...
#if DEBUG
			cout << "FIFO Level: " << fifo_level << endl;
#endif
			...
			if( fifo_level > 0) {
				...
				if( bytes_read >= 4 ) {
					...
					for ( i = 0; i < gesture_data_.total_gestures; i++ ) {
						cout << gesture_data_.u_data[i] << " " << endl;
					}
					cout << endl;
#endif
...
bool APDS9960_RPi::processGestureData()
{
	...
	if( (gesture_data_.total_gestures <= 32) && \
		...
		for( i = gesture_data_.total_gestures - 1; i >= 0; i-- ) {
			...
			cout << "Finding last: ";
			cout << "U:";
			cout << gesture_data_.u_data[i];
			cout << " D:";
			cout << gesture_data_.d_data[i];
			cout << " L:";
			cout << gesture_data_.l_data[i];
			cout << " R:";
			cout << gesture_data_.r_data[i] << endl;
#endif
			if( (gesture_data_.u_data[i] > GESTURE_THRESHOLD_OUT) &&
					(gesture_data_.d_data[i] > GESTURE_THRESHOLD_OUT) &&
					(gesture_data_.l_data[i] > GESTURE_THRESHOLD_OUT) &&
	...
	cout << "Accumulations: ";
	cout << "UD: ";
	cout << gesture_ud_delta_;
	cout << " LR: ";
	cout << gesture_lr_delta_ << endl;
#endif
...
#if DEBUG
	cout << "UD_CT: ";
	cout << gesture_ud_count_;
	cout << " LR_CT: ";
	cout << gesture_lr_count_;
	cout << " NEAR_CT: ";
	cout << gesture_near_count_;
	cout << " FAR_CT: ";
	cout << gesture_far_count_ << endl;
	cout << "----------" << endl;
#endif
